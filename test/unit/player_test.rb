...
class PlayerTest < ActiveSupport::TestCase
  ...
  should have_many :active_actions
      ...
      context ", the turn player" do
        ...
        context "waiting to buy" do
          ...
          should "be able to buy" do
            ...
            assert_match(/^player_gain.*#{@ply.id}/, @game.active_actions(true)[0].expected_action)
            assert_equal [], @ply.active_actions(true)
          end
          
          should "reject buy of a non-existant pile" do
            assert_match(/out of range/, @ply.buy(:pile_index => 1000))
            assert_equal "buy", @ply.active_actions(true)[0].expected_action
          end
...
EOF
        ...
        should "gain actions" do
          @ply.add_actions(2, @ply.active_actions[0])
          pid = @ply.id
          patt = <<EOF
---
>
...
EOF
        ...
        should "gain buys" do
          assert_equal("play_action", @ply.add_buys(2, @ply.active_actions[0]).expected_action)
          pid = @ply.id
          patt = <<EOF
---
>
