...
Rails.application.configure do
  ...
  config.hosts << Rails.application.default_url_options[:host]
  ...
  config.log_level = ENV['STAGING_SERVER'] ? :debug : :info
  ...
  # config.active_job.queue_name_prefix = "dominion_production"
  ...
  config.active_support.report_deprecations = !!ENV['STAGING_SERVER']
  ...
  config.x.admin_email = Rails.application.credentials.mail[:admin_email]
end
