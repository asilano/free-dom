 ...
 */
  ...
  $(document).delegate(rails.formInputClickSelector, 'click.rails', function(event) {
    ...
    if (attrForm == undefined || !attrForm.is('form') || attrForm == button.closest('form')) {
      ...
      // Button's form is not its closest ancestor. That means that the event triggering
      // is probably out of order. Set data, and fire the form explicitly.
      attrForm.data('ujs:submit-button', data);
      // attrForm.trigger('submit.rails');
    }
