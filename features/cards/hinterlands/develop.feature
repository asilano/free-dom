Feature: Develop - Action: 3
  ...
  Background: Game contains Estate
    Given I am a player in a standard game with Develop, Moat, Thief, Salvager
  ...
  Scenario: Playing Develop. Choices for trash and both gains.
    ...
    When I choose Woodcutter in my hand
      ...
      And I should not be able to choose the Silver, Gold piles
    ...
    And the game checks actions
      ...
      And I should not be able to choose the Estate, Moat, Silver, Gold piles
  ...
  Scenario: Playing Develop. Only one option for trash and each gain
    ...
    When I play Develop
      ...
      And I should not be able to choose the Silver, Gold, Estate, Salvager piles
    When I choose the Moat pile
    And the game checks actions
